 ...
 * @Description :
 */
public class ParseDataModel<T> extends AsyncHttpResponseHandler {
	...
	public ParseDataModel(String url, RequestParams params, TypeToken typeToken,
			IParseListener listen) {
	...
	void setBean(String response, Type typeToken) {
		...
		BaseModelGson resultBean = (BaseModelGson) gson.fromJson(response, typeToken);
